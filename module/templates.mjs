...
export const preloadHandlebarsTemplates = async function () {
  ...
  const templatePaths = [
    ...
    `systems/${SYSTEM.ID}/templates/items/parts/item-sidebar.hbs`,
    `systems/${SYSTEM.ID}/templates/items/parts/equipment/equipment-partial.hbs`,
    `systems/${SYSTEM.ID}/templates/items/parts/feature/feature-partial.hbs`,
    `systems/${SYSTEM.ID}/templates/items/parts/profile/profile-partial.hbs`,
    `systems/${SYSTEM.ID}/templates/items/parts/path/path-partial.hbs`,
    `systems/${SYSTEM.ID}/templates/items/parts/attack/attack-partial.hbs`,
    `systems/${SYSTEM.ID}/templates/items/parts/capacity/capacity-partial.hbs`,
