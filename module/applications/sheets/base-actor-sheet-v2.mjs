...
export default class CoBaseActorSheetV2 extends HandlebarsApplicationMixin(foundry.applications.sheets.ActorSheetV2) {
  ...
  static DEFAULT_OPTIONS = {
    ...
    actions: {
      ...
      sizeChange: CoBaseActorSheetV2.#onSizeChange,
      learnCapacity: CoBaseActorSheetV2.#onLearnCapacity,
      unlearnCapacity: CoBaseActorSheetV2.#onUnlearnCapacity,
      deleteCustomEffect: CoBaseActorSheetV2.#onDeleteCustomEffect,
    },
  }
